<div class="hero-container container">
    ...
    <div class="hero_img-container">
        <div>
            <img src=" <?= Website('images/hero.png') ?>" alt="" class="img-fluid">
        </div>
    </div>
</div>
</section>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="about_img-container">
                        <img src="<?= Website('images/about.png') ?>" alt="">
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="admission_img-container">
                        <img src="<?= Website('images/admission.png') ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="why_img-container">
                        <img src="<?= Website('images/why.png') ?>" alt="">
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="determine_img-container">
                        <img src="<?= Website('images/determine.png') ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="contact_img-box">
                    <img src="<?= Website('images/students.jpg') ?>" alt="">
                </div>
            </div>
        </div>
    </div>
